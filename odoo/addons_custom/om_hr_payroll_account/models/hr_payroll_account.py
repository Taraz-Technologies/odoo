...
class HrPayslip(models.Model):
    ...
    date = fields.Date('Date Account', states={'draft': [('readonly', False)]}, readonly=True, required=True,
                       default=lambda self: fields.Date.to_string(datetime.now().date()),
    ...
    def action_payslip_cancel(self):
        ...
        moves.filtered(lambda x: x.state in ['draft', 'posted']).button_cancel()
